...
{
    public partial class trade203Context : DbContext
    {
        public trade203Context()
        {
        }

        public trade203Context(DbContextOptions<trade203Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=localhost;user=root;port=3306;password=ELINA2030;database=trade203");
            }
        }
